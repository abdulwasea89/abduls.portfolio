            ...
            <nav className="p-6 border-b border-border-color">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <p className="text-light-gray-2 font-medium">Local Time ( PKT )</p>
                        <div className="bg-dark-gray-1 border-[rgb(24,24,26)] p-[14px_18px] w-[150px] rounded-xl flex items-center justify-center">
